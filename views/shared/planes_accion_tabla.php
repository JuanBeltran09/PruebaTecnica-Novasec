<!-- views/shared/planes_accion_tabla.php -->
<!-- H-6778: Componente reutilizable - Tabla de planes de acción -->
<!-- Variables requeridas: $planesAccion, $entity, $id_registro, $estados, $usuarios -->
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <a href="index.php?entity=<?= $entity ?>&action=planes_accion&id=<?= $id_registro ?>&delete_plan=<?= $plan['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Está seguro de eliminar este plan de acción?')">Eliminar</a>
            </td>
        </tr>
